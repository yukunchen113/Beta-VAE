...
#beta = 1000
#main(save_folder="1000-Beta-VAE", kld_function=lambda **kwargs: 1000)

#beta = 10000
#main(save_folder="10000-Beta-VAE", kld_function=lambda **kwargs: 10000)
...
main(save_folder="KLD_Decrease_40000_steps-100to0-Beta-VAE", kld_function=lambda step,**kwargs: max(1, 100-step/400), validation_off=True, max_steps = 50000)

#KLD decreasing to 0 from 10000 in 100000 steps
main(save_folder="KLD_Decrease_100000_steps-10000to0-Beta-VAE", kld_function=lambda step,**kwargs: max(1, 10000-step/10), validation_off=True, max_steps = 125000)
